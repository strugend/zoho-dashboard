...
const CreditNotes= () => {
        ...
        <title>Credit Notes | ZOHO Books</title>
            <Row>
                <Col sm={9}>
                    ...
                    <Nav>
                        <Dropdown menu={menu} name="All Credit Notes" header="DEFAULT FILTERS" key="all Credit Notes"></Dropdown>
                    </Nav>
                </Col>
  ...
  <div class="vr"></div>
        ...
        <div className="text-center mt-3">
            ...
            <Button variant="primary">CREATE NEW CREDIT NOTE</Button>
           <p> <Button variant="link">Import Credit Notes</Button></p>
